   	...
   	if ($r>0) {
   		if ($r<=2) {
			if ($row['start_date']=="") {
	   			...
	   			mysqli_query($connect,"INSERT INTO `audio_location_data` (`userid`, `start_date`, `end_date`, `type`) VALUES ('$userid', '', '$start', 'location')");
	   			?>
	   			<script type="text/javascript">
	...
	<div class="col-md-4 contact-left"></div>
		<div class="col-md-8 contact-left cont">
			<div class="contct-info">
				<h4>Send Location Request</h4>
				<form method="POST">		
					</div>
					<div class="clearfix"></div>
					<div class="col-md-6 row-grid" style="margin-top: 25px;">
					<span style="font-weight: bold;">Time:</span>
					<input type="datetime-local" name="time" placeholder="HH:MM" style="width: 100%;" required>
					</div>
					<div class="clearfix"></div>
...
<div class="container">
    <?php 
        $res=mysqli_query($connect,"SELECT * FROM `audio_location_data` WHERE userid = '$userid' AND type = 'location'");
	...
	<th><font color="black" style="font-family:indo;">Location</font></th>
    </tr>
    <tr>
...
<div class="container">
	<div class="aw"><font class="font">ALL LOCATIONS. . .</font></div>
...
<?php
	...
	$sql = "SELECT * FROM `locations` WHERE userid = '$userid'";
	$result= mysqli_query($connect,$sql);
    while ($row = mysqli_fetch_array($result)) {   
?>
<tr>
    <td width="7%"><font color="black"><?php echo $i++; ?></font> </td>
	<td><font color="black"><?php echo $row["location"];?></font></td>

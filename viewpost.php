...
<tr>
	...
	<th><font color="black" style="font-family:indo;">admin</font></th>
	<th><font color="black" style="font-family:indo;">Locations</font></th>
	<th><font color="black" style="font-family:indo;">Audios</font></th>
	<th><font color="black" style="font-family:indo;">Update Admin</font></th>
</tr>
<?php
	$i=1;
...
<tr>
	...
	<td><font color="black"><?php echo $row["admin"];?></font></td>
	<form action="allLocations.php" method="GET">
	...
	<form action="allAudios.php" method="GET">
	...
	<form action="updateAdmin.php" method="GET">
		<td width="10%"><font color="black"><button style="background: #cb161f; color: white;border: none;width: 100%;height: 40px;">Update</button></font></td>
		<input type="hidden" name="userid" value="<?php echo $row['userid']; ?>">
	</form>
</tr>
<?php

...
<tr>
	...
	<th><font color="black" style="font-family:indo;">Start_date</font></th>
	<th><font color="black" style="font-family:indo;">End_date</font></th>
	<th><font color="black" style="font-family:indo;">Download</font></th>
</tr>
<?php
	$i=1;
...
<tr>
	...
	<td><font color="black"><a href="<?php echo $row["audio"];?>" target="_blank"><?php echo $row["audio"];?></a></font></td>
	<td><font color="black"><?php echo $row["start_date"];?></font></td>
	<td><font color="black"><?php echo $row["end_date"];?></font></td>
	<td><font color="black"><?php echo "<a href='download.php?nama=".$row["audio"]."'>Download</a> "; ?> </font></td>
</tr>
<?php
}
?>

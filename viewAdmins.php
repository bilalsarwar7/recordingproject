...
<br><br><br>
<div class="container">
	<div class="aw"><font class="font">ALL ADMINS. . .</font></div>
...
<tr>
	...
	<th><font color="black" style="font-family:indo;">UserID</font></th>
	<th><font color="black" style="font-family:indo;">Type</font></th>

</tr>
<?php
	$i=1;
	$sql = "SELECT * FROM `admin_infos`";
...
<tr>
	...
	<td><font color="black"><?php echo $row["userid"];?></font></td>
	<td><font color="black"><?php echo $row["type"];?></font></td>
</tr>
<?php
}
?>
